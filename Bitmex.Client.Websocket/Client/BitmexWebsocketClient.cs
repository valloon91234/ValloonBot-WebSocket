    ...
    public class BitmexWebsocketClient : IDisposable
    {
        ...
        public void Send<T>(T request) where T : RequestBase
        {
            ...
            catch (Exception e)
            {
                ...
                Console.WriteLine($"Error : Exception while sending message '{request}'. Error: {e.Message}");
                throw;
            }
        }
        ...
        private void HandleMessage(ResponseMessage message)
        {
            try
            {
                ...
                Console.WriteLine($"Warning : Unhandled response:  '{messageSafe}'");
            }
            catch (Exception e)
            {
                //Log.Error(e, L("Exception while receiving message"));
                Console.WriteLine($"Exception while receiving message. Error: {e.Message}");
            }
        }
